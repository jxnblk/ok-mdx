...
module.exports = async (opts) => {
  ...
  // const OVERLAY_PORT = await getPort()
  // process.env.WEBPACK_SERVE_OVERLAY_WS_URL = 'ws://localhost:' + OVERLAY_PORT
  ...
  config.plugins.push(
    ...
    new webpack.DefinePlugin({
      ...
      // 'process.env': { WEBPACK_SERVE_OVERLAY_WS_URL: JSON.stringify('ws://localhost:' + OVERLAY_PORT) }
    })
  )
